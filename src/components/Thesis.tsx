...
export function Thesis() {
  return (
    <section id="study" className="bg-ground">
      <div className="mx-auto max-w-5xl px-6 py-24 md:py-36 text-center">
        <Reveal>
          <p className="meta-label text-muted mb-8">Why Atlas exists</p>
        </Reveal>
        <Reveal delay={0.1}>
          <p className="font-display text-3xl md:text-5xl leading-[1.2] text-text">
            Research literacy is a function of{" "}
            <span className="italic">access</span>, not ability.
          </p>
        </Reveal>
        <Reveal delay={0.25}>
          <p className="mt-8 mx-auto max-w-2xl text-muted leading-relaxed">
